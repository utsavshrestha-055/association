                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{ url('/admin/button') }}" class="dropdown-item">Buttons</a>
                            <a href="{{ url('/admin/typography') }}" class="dropdown-item">Typography</a>
                            <a href="{{ url('/admin/element') }}" class="dropdown-item">Other Elements</a>
                        </div>
                    </div>
                    ...
                    <a href="{{ url('/admin/charts') }}" class="nav-item nav-link"><i class="fa fa-chart-bar me-2"></i>Charts</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle active" data-bs-toggle="dropdown"><i class="far fa-file-alt me-2"></i>Pages</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{ url('/admin/signin') }}" class="dropdown-item">Sign In</a>
                            <a href="{{ url('/admin/signup') }}" class="dropdown-item">Sign Up</a>
                            <a href="{{ url('/admin/404') }}" class="dropdown-item active">404 Error</a>
                            <a href="{{ url('/admin/blank') }}" class="dropdown-item">Blank Page</a>
                        </div>
                    </div>
                </div>
            </nav>
